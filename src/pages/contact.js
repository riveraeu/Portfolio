  ...
  <Layout>
    ...
    <div data-sal="zoom-in" className={ContactStyles.containerContact}>
      <div className={ContactStyles.contactCol1}>
        <img src="./contact/profile-picture.jpg" alt="profile of Eugene" />
      </div>
      <div className={ContactStyles.contactCol2}>
        <p>Eugene was born and raised in the SF Bay Area. He studied computer science in college and has been a freenlance web developer since graduating in 2017.</p>
        ...
        <p className={ContactStyles.center}><a style={{textDecoration: "underline"}} href="mailto:eugenejrivera@gmail.com">Send Eugene a messege</a></p>
